...
api.nvim_set_keymap('n', '<leader>ff', ':GFiles!<CR>', {noremap = true})
api.nvim_set_keymap('n', '<leader>g', ':Files!<CR>', {noremap = true})
...
api.nvim_set_keymap('n', '<leader>fs', ':History/!<CR>', {noremap = rue})
...
api.nvim_set_keymap('n', '<leader>r', '<leader>fg', {noremap = false})
